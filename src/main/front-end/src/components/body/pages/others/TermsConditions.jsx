        ...
        <Grid item xs={11} sm={10} md={10} lg={8}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Full Stack App.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Full Stack App, accessible
                from{" "}
                <a
                  href="http://www.fullstackapp.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://www.fullstackapp.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul style={{ marginBottom: "64px" }}>
            <li>
              ...
              <a
                href="http://www.fullstsackapp.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.fullstsackapp.com/contact
              </a>
            </li>
          </ul>
        </Grid>

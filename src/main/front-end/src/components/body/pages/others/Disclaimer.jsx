    ...
    <>
      ...
      >
        <Grid item xs={11} sm={10} md={10} lg={8}>
          <h1>Disclaimer</h1>
          <p>Last updated: September 23, 2021</p>
          ...
          <ul>
            <li>
              ...
              in this Disclaimer) refers to Full Stack App.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Full Stack App, accessible from{" "}
              <a
                href="http://www.fullstackapp.io"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.fullstackapp.io
              </a>
            </li>
          </ul>
          <h1>Disclaimer</h1>
          ...
          <ul style={{ marginBottom: "64px" }}>
            <li>
              ...
              <a
                href="http://www.fullstackapp.io/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.fullstackapp.io/contact
              </a>
            </li>
          </ul>
        </Grid>
